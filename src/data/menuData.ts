...
export const gnbMenuData: MenuItem[] = [
  ...
  },
  {
    ...
    href: '/marketing',
    subMenu: [
      { label: '해외지사', href: '/marketing' },
      { label: '국방대리점', href: '/marketing' },
      { label: '국내대리점', href: '/marketing' },
      { label: '해외대리점', href: '/marketing' },
      { label: '전문특판점', href: '/marketing' },
      { label: '주요고객사', href: '/marketing' },
    ],
  },
  {
    label: '고객지원',
