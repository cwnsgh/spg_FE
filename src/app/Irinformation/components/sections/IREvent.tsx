...
export default function IREvent() {
  ...
  const eventData: EventItem[] = [
    { id: 1, eventName: "행사명 01", time: "2025-12-09", fileUrl: "#", detailUrl: "#" },
    { id: 2, eventName: "행사명 02", time: "2025-09-17", fileUrl: "#", detailUrl: "#" },
    { id: 3, eventName: "행사명 03", time: "2025-08-25", fileUrl: "#", detailUrl: "#" },
    { id: 4, eventName: "행사명 04", time: "2025-07-29", fileUrl: "#", detailUrl: "#" },
    { id: 5, eventName: "행사명 05", time: "2025-03-26", fileUrl: "#", detailUrl: "#" },
    { id: 6, eventName: "행사명 06", time: "2025-03-18", fileUrl: "#", detailUrl: "#" },
    { id: 7, eventName: "행사명 07", time: "2025-03-18", fileUrl: "#", detailUrl: "#" },
    { id: 8, eventName: "행사명 08", time: "2025-03-11", fileUrl: "#", detailUrl: "#" },
    { id: 9, eventName: "행사명 09", time: "2025-03-04", fileUrl: "#", detailUrl: "#" },
    { id: 10, eventName: "행사명 10", time: "2025-12-09", fileUrl: "#", detailUrl: "#" },
    { id: 11, eventName: "행사명 11 행사명 11 행사명 11", time: "2025-09-17", fileUrl: "#", detailUrl: "#" },
    { id: 12, eventName: "행사명 12", time: "2025-08-25", fileUrl: "#", detailUrl: "#" },
    { id: 13, eventName: "행사명 13", time: "2025-07-29", fileUrl: "#", detailUrl: "#" },
    { id: 14, eventName: "행사명 14", time: "2025-03-26", fileUrl: "#", detailUrl: "#" },
    { id: 15, eventName: "행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다 행사명 15 입니다", time: "2025-03-18", fileUrl: "#", detailUrl: "#" },
    { id: 16, eventName: "행사명 16 행사명 16 행사명 16 행사명 16", time: "2025-03-18", fileUrl: "#", detailUrl: "#" },
    { id: 17, eventName: "행사명 17", time: "2025-03-11", fileUrl: "#", detailUrl: "#" },
    { id: 18, eventName: "행사명 18", time: "2025-03-04", fileUrl: "#", detailUrl: "#" },
  ];
  ...
  const filteredData = useMemo(() => {
    ...
    return eventData.filter((item) => {
      if (searchType === "subject") {
        ...
        return item.eventName.includes(searchKeyword) || item.time.includes(searchKeyword);
      }
    });
