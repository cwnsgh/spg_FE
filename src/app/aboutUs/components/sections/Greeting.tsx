        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.textContent}>
            ...
            <div className={styles.rightColumn}>
              <p>
                SPG는 대한민국을 대표하는 기어드 모터 및 정밀 감속기 전문
                기업으로, 수십년간 축적된 기술력으로 소형 감속기부터 고정밀
                감속기를 개발 생산합니다.
              </p>
              <p>
                스마트팩토리, 서비스 로봇, 의료수술 시스템 등 4차 산업혁명 핵심
                분야에 필요한 고성능 감속기와 모터 개발 기술을 선도하며, 미래
                산업의 동력을 만들어갑니다.
              </p>
              <p>
                현재 40여 개의 제품을 공급하며, 글로벌 고객과 함께 성장하며 혁신
                기술과 철저한 품질 경영으로 세계 시장에서 인정받는 글로벌 솔루션
                리더로 도약하고 있습니다.
              </p>
              <p>
                앞으로도 SPG는 고객 감동과 가치 경영이라는 철학 아래, 고객의
                니즈를 먼저 생각하고, 최고의 서비스를 제공하는 기업으로
                자리매김하겠습니다.
              </p>
